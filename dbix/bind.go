...
type ContractBackend struct {
	eapi  *PublicEthereumAPI        // Wrapper around the Dubaicoin object to access metadata
...
// Etheruem object.
func NewContractBackend(dbix *Dubaicoin) *ContractBackend {
	return &ContractBackend{
		eapi:  NewPublicEthereumAPI(dbix),
		bcapi: NewPublicBlockChainAPI(dbix.chainConfig, dbix.blockchain, dbix.miner, dbix.chainDb, dbix.gpo, dbix.eventMux, dbix.accountManager),
		txapi: NewPublicTransactionPoolAPI(dbix),
	}
}
