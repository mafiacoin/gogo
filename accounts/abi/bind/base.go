...
// valid Dubaicoin transaction.
type TransactOpts struct {
	From   common.Address // Dubaicoin account to send the transaction from
...
// Dubaicoin network. It contains a collection of methods that are used by the
// higher level contract bindings to operate.
type BoundContract struct {
	address    common.Address     // Deployment address of the contract on the Dubaicoin blockchain
	abi        abi.ABI            // Reflect based ABI to access the correct Dubaicoin methods
