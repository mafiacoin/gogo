...
import (
	...
	"github.com/dbix-project/go-dubaicoin/xeth"
...
func GetNotice(xeth *xdbix.XEth, tx string, http *httpclient.HTTPClient) (notice string) {
...
func New(xeth *xdbix.XEth, jsontx string, http *httpclient.HTTPClient) (self *NatSpec, err error) {
...
func FetchDocsForContract(contractAddress string, xeth *xdbix.XEth, client *httpclient.HTTPClient) (content []byte, err error) {
	// retrieve contract hash from state
	codehex := xdbix.CodeAt(contractAddress)
	codeb := xdbix.CodeAtBytes(contractAddress)
...
func (self *NatSpec) Notice() (notice string, err error) {
	...
	notice, err = self.noticeForMethod(self.tx, mdbix.name, mdbix.Notice)
	return
}
