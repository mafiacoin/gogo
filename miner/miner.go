...
// Package miner implements Dubaicoin block creation and mining.
package miner
...
func New(dbix core.Backend, config *core.ChainConfig, mux *event.TypeMux, pow pow.PoW) *Miner {
	miner := &Miner{dbix: dbix, mux: mux, pow: pow, worker: newWorker(config, common.Address{}, dbix), canStart: 1}
	go miner.update()
