...
// ReleaseOracle is an Dubaicoin contract to store the current and previous
// versions of the go-ethereum implementation. Its goal is to allow Gdbix to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new Gdbix releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular Gdbix release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an Dubaicoin user, either
