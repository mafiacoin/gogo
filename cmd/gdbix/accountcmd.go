		...
		Subcommands: []cli.Command{
			{
				Action: importWallet,
				Name:   "import",
				Usage:  "import dubaicoin presale wallet",
			},
		},
		Description: `
...
between dubaicoin nodes by simply copying.
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    dubaicoin --password <passwordfile> account new
...
password to file or expose in any other way.
    ...
    dubaicoin account update <address>
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    dubaicoin --password <passwordfile> account update <address>
...
changing your password is only possible interactively.
    ...
    dubaicoin account import <keyfile>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    dubaicoin --password <passwordfile> account import <keyfile>

Note:
As you can directly copy your encrypted accounts to another dubaicoin instance,
